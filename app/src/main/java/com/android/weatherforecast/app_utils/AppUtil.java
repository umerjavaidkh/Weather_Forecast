...
public class AppUtil {
  ...
  public static String getWeatherStatus(int weatherCode, boolean isRTL) {
    if (weatherCode / 100 == 2) {
        ...
        return Constants.getWEATHER_STATUS()[0];

    } else if (weatherCode / 100 == 3) {

        return Constants.getWEATHER_STATUS()[1];

    } else if (weatherCode / 100 == 5) {

        return Constants.getWEATHER_STATUS()[2];

    } else if (weatherCode / 100 == 6) {

        return Constants.getWEATHER_STATUS()[3];

    } else if (weatherCode / 100 == 7) {

        return Constants.getWEATHER_STATUS()[4];

    } else if (weatherCode == 800) {

        return Constants.getWEATHER_STATUS()[5];

    } else if (weatherCode == 801) {

        return Constants.getWEATHER_STATUS()[6];

    } else if (weatherCode == 803) {

        return Constants.getWEATHER_STATUS()[7];

    } else if (weatherCode / 100 == 8) {

        return Constants.getWEATHER_STATUS()[8];
    }
